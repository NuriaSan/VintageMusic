...
<?php
    ...
    if (isset($_POST["confirmar"])) {
        ...
        if (Usuario::eliminarUsuario($dniUsuario)) {
            session_destroy();
            echo '<script type="text/javascript">setTimeout(function(){ window.location.href = "../login.php?mensaje=eliminado"; }, 0);</script>';
            exit();
        } else {
        ...
        <div class="row">
            <div class="col-md-6">
                <div id="datosmostrados">
                    ...
                    <form id="formularioEliminar" method="POST" action="eliminareditor.php">
                        <div class="mb-3">
            ...
            <div class="col-md-6">
                <div id="accionesusuario">
                    <div class="titulo2">
                        <h2>¿Quiere borrar su cuenta de Editor?:</h2>
                        <p>Deberá tener en cuenta que tras confirmar la eliminación no podrá acceder a su cuenta de Usuario y perderá todos sus datos.</p>
                    </div>
                    <div class="col-md-12 mt-5 text-center align-self-center">
                        <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#confirmarModal">
                            Confirmar Cambios
                        </button>
                    </div>
                </div>
...
<div class="container">
    <div class="row align-items-center">
            <div class="col-md-12 mt-5 text-center align-self-center">
                <button type="button" class="btn btn-secondary col-12" onclick="window.location.href='login.php'">
                    Ir a Log In
                </button>
            </div>
    </div>
