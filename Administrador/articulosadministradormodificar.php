...
// Obtiene el articulo a modificar desde la URL
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" ) {
        ...
        if (isset($_FILES["nuevaImagen"]) && $_FILES["nuevaImagen"]["name"]) {
            ...
            $directorioImagenes = "../Editor/articulosImg/"; 
        ...
        if ($resultado) {
            ...
            echo '<script type="text/javascript">setTimeout(function(){ window.location.href = "articulosadministradormodificar.php?cod_articulo=' . $codigo_articulo . '&mensaje=exito"; }, 0);</script>';
            exit();
        } else {
    ...
    <div id="contenedor" style="width: 100%">
        ...
        <?php endif; ?>
            ...
            <div class="formulario" style="width: 30%; margin: auto; padding: 20px 30px; background-color: #c8e0f0; text-align: left; border-radius: 5px;">
                <form method="POST" action="articulosadministradormodificar.php?cod_articulo=<?php echo $codigo_articulo; ?>" enctype="multipart/form-data">
                    ...
                    <div style="text-align: center;">
                        <img src="<?php echo "../Editor/".$imagenActual; ?>" alt="Vista previa de la imagen" style="width: 200px; height: 200px; margin: auto;">
                    </div>
                    ...
                    <input type='button' value='Volver' style="border:none;background-color: #3282b8; color: white; font-size: 16px; height: 50px; border-radius: 5px; width: 100%;" onclick='window.location.href="registroarticulosadministrador.php";'>
