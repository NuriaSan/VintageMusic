...
<body class="text-center" style="background-color: aliceblue;">
    ...
    <h1 class="mt-5">Sesión de Administrador</h1>
    ...
    <div class="container mt-5 text-center">
        <form action="registroarticulosadministrador.php" method="get">
            <div class="acciones d-flex justify-content-between mt-5">
                <div id="botonAgregar">
                    <a class="btn btn-primary" href="formularioarticulosadministrador.php">Agregar Articulo</a>
                </div>
                <div id="botonAtras">
                    <a class="btn btn-secondary" href="sesionadministrador.php">Volver a la Sesión Principal</a>
                </div>
                <div id="logout">
            ...
            <div class="ordenacion_nombre mt-4">
                ...
                <a href="registroarticulosadministrador.php?sort=nombre_asc" class="btn btn-link">Nombre Ascendente ▲</a>
                <a href="registroarticulosadministrador.php?sort=nombre_desc" class="btn btn-link">Nombre Descendente ▼</a>
            </div>
                        ...
                        while ($datos = $stmt->fetch(PDO::FETCH_ASSOC)) {
                            echo "<tr>
                                    ...
                                    <td style='background-color:white; font-size: 16px; padding:15px; margin:15px;'>
                                        <img src='../Editor/"  . $datos["imagen"] . "' alt='imagen' style='width: 250px; height: 250px; margin:0; padding: 0;'>
                                    <td style='background-color:white; font-size: 24px; padding: 20px;'><a href='articulosadministradorrmodificar.php?cod_articulo=" . $datos["cod_articulo"] . "'>&#128221;</a></td>
                                    <td style='background-color:white; font-size: 24px; padding: 20px;'><a href='articulosadministradoreliminar.php?cod_articulo=" . $datos["cod_articulo"] . "'>&#10060;</a></td>
                                    </td>
                                </tr>";
                        }
                    ...
                    <ul class="pagination">
                        <?php
                            for ($i = 1; $i <= $totalPaginas; $i++) {
                                ...
                                echo "<li class='page-item $claseActiva'><a class='page-link' href='registroarticulosadministrador.php?pagina=" . $i . "'>$i</a></li>";
                            }
                        ?>
                    </ul>
                </div>
