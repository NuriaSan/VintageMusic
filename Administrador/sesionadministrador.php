        ...
        <div class="col-md-12">
                <div id="datosmostrados">
                    ...
                    <div id="espacioadministrador" class="mb-3">
                        <button class="btn btn-secondary w-100" type="button" onclick="mantenimientoUsuarios()">Gestión de Usuarios</button>
                    </div>
                    <div id="espacioadministrador" class="mb-3">
                    ...
                    <script>
                        ...
                        function verUsuario() {
                            window.location.href = "sesionadministrador2.php?dni=";
                        }
                        ...
                        function registroArticulos() {
                            window.location.href = "registroarticulosadministrador.php?dni=";
                        }
